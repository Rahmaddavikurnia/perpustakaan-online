                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending">Nama User</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jurusan: active to sort column">Email</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="kategori: active to sort column">Role</th>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('updateuser', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
