        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Data Daftar Buku</h3>
                            ...
                            <div id="basic_datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap-4">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="dataTables_filter" id="basic-datatables_filter">
                                      <a href="{{route('buku.generate')}}" class="btn btn-success">Cetak</a>
                                    </div>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending">Judul Buku</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jurusan: active to sort column">Penerbit</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="kategori: active to sort column">Kategori Buku</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jabatan: active to sort column">Penulis</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="stok: active to sort column ascending">Stok Buku</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending">Foto Buku</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>{{$item->penulis}}</td>
                                                <td>{{$item->stok}}</td>
                                                <td><img src="{{asset ('storage/images/buku/' .$item->gambar)}}" alt="img" height="50px"></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <form action="{{route('buku.update', $item)}}" method="get">
                                                            @csrf
                                                            <button
                                                            type="submit"
