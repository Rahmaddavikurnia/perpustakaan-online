        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Data Pengembalian Buku</h3>
                            ...
                            <div id="basic_datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap-4">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="dataTables_filter" id="basic-datatables_filter">
                                        <a href="{{route('pengembalian.generate')}}" class="btn btn-success">Cetak</a>
                                    </div>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            colspan="1" aria-sort="ascending" aria-label="Nama Jurusan: active to sort column descending">Nama Peminjam</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="jurusan: active to sort column">Judul Buku</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="kategori: active to sort column">Tanggal Pengembalian</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-sort="ascending" aria-label="status: active to sort column">Status Pengembalian</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select" rowspan="1" 
                                            colspan="1" aria-label="Foto: active to sort column ascending">Denda</th>
                                        </tr>
                                        </thead>
                                        <tbody>
